...
BEGIN
   ...
   CURSOR encargado_cur is 
        SELECT id_encargado,nombre,rut,telefono,foto FROM ENCARGADO;
    BEGIN 
   OPEN encargado_cur; 
...
BEGIN
   ...
   CURSOR guia_cur is 
        SELECT id_guia,nombre,rut,telefono,foto FROM GUIA_TURISTICO;
    BEGIN 
   OPEN guia_cur; 
    DBMS_OUTPUT.put_line('[');
   LOOP 
...
BEGIN
   ...
   CURSOR chofer_cur is 
        SELECT id_chofer,nombre,rut,telefono,foto FROM CHOFER;
    BEGIN 
   OPEN chofer_cur; 
    DBMS_OUTPUT.put_line('[');
   LOOP 
