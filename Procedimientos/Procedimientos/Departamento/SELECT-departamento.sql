...
BEGIN
   ...
   DBMS_OUTPUT.put_line('[');
   LOOP 
   FETCH departamento_cur_estado into v_id_departamento,v_num_habitacion, v_numero_habitaciones, v_metros_cuadrados,v_banios,v_piso,v_precio_noche,v_nombre_edificio,v_nombre_es,v_activo; 
